...
/***/ (function(module, exports, __webpack_require__) {
	...
	var CustomForm = __webpack_require__(34);
	var Blurrable = __webpack_require__(35);
	var YoutubeList = __webpack_require__(36);
	var RecReading = __webpack_require__(37);

	$(function () {
	  var cf = new CustomForm();
	  cf.initialize();
	  var ytl = new YoutubeList();
	  ytl.initialize();
	  var rr = new RecReading();
	  rr.initialize();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function CustomForm() {
	  ...
	  this.buildDropdown = function (i, o) {
	    ...
	    var $current = $('<p>').addClass('dropdown__selected-item');
	    var $list = $('<ul>').addClass('dropdown__list');
	    ...
	    $(this).children('option').each(function (i, o) {
	      var $item = $('<li>').text($(this).text()).attr('data-value', $(this).val());
	  ...
	  this.syncDropdownToSelect = function (e) {
	    ...
	    $(this).closest('.dropdown').removeClass('on').siblings('select').each(function (i, o) {
	  ...
	  this.syncSelectToDropdown = function (i, o) {
	    ...
	    $(this).siblings('.dropdown').each(function (i, o) {
	      var $current = $(this).find('.dropdown__selected-item');
	...
	function Blurrable() {
	  this.initialize = function () {
	    $(".blurrable").each(function (i, o) {
	      var $this = $(o);
	      var $box = $this.find(".blurrable__box");
	      var $copy = $box.clone();
	      var $layover = $this.find(".blurrable__layover");
	      var $blur = $("<div/>");
	      $box.css("min-height", $layover.outerHeight());
	      $copy.removeClass("blurrable__box").addClass("blurrable__box--copy").height($box.outerHeight()).width($box.width());
	      $blur.html($copy).addClass("blurrable__blur").height($layover.outerHeight());
	      $this.append($blur);
	    });
	  };
	}
